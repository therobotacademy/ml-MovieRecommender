...
if __name__ == '__main__':
	...
	download("https://s3-us-west-2.amazonaws.com/static.turi.com/sample-movie-recommender/user_names.csv", path.join(data_dir, 'ml-20m/user_names.csv'))
	download("https://s3-us-west-2.amazonaws.com/static.turi.com/sample-movie-recommender/movie_urls.csv", path.join(data_dir, 'ml-20m/movie_urls.csv'))
